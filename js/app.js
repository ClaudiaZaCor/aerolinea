/*Declarar un array que represente a los asientos de nuestro avion con false indicando que estos estan vacios */
var airlineSeats = [
  false,
  false,
  false,
...
var paintSeats = function(array) {
  ...
  for(var i=0; i<array.length; i++) {
    ...
    if (i < 4) {
      seat.style.background = 'crimson';
    } else {
      seat.style.background = 'cornflowerblue';
    }
